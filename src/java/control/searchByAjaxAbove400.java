 ...
 * @author Admin
 */
@WebServlet(name="searchByAjaxAbove400", urlPatterns={"/searchByAjaxAbove400"})
public class searchByAjaxAbove400 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        dao dao = new dao();
        List<Product> list = dao.searchPriceAbove400();
