 ...
 * @author Admin
 */
@WebServlet(name="searchByAjax300to400", urlPatterns={"/searchByAjax300to400"})
public class searchByAjax300to400 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        dao dao = new dao();
        List<Product> list = dao.searchPrice300to400();
