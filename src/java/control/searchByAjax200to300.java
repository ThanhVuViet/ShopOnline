 ...
 * @author Admin
 */
@WebServlet(name="searchByAjax200to300", urlPatterns={"/searchByAjax200to300"})
public class searchByAjax200to300 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        dao dao = new dao();
        List<Product> list = dao.searchPrice200to300();
