<%-- 
    Document   : home
    Created on : Mar 6, 2024, 6:22:18 AM
    Author     : Admin
--%>
...
<html>
    ...
    int countProduct = (int) session.getAttribute("count");
     ...
     if (categoryList != null) {
            ...
            <div class="row px-xl-5 pb-3">
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="category?cid=<%= category.getCateID() %>" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="<%= category.getImg() %>" alt="<%= category.getCname() %>">
                        </a>
                        <h5 class="font-weight-semi-bold m-0"><%= category.getCname() %></h5>
                    </div>
                </div>
                <% 
                        }
        ...
        <!-- Products Start -->
        <%
    List<Product> highestProductList = (List<Product>) request.getAttribute("highestProductList");
        %>
        <div class="container-fluid pt-5">
            ...
            <div class="row px-xl-5 pb-3">
                <% for (Product product : highestProductList) { %>
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="<%= product.getpImage() %>" alt="<%= product.getpName() %>">
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="detail?pid=<%= product.getpID() %>" class="btn btn-sm text-dark p-0">
                                <i class="fas fa-eye text-primary mr-1"></i>View Detail
                            </a>
                            <a href="addCartShop?pid=<%=product.getpID() %>" class="btn btn-sm text-dark p-0">
