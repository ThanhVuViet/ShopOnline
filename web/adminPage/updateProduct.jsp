...
<html>
    ...
    <body>
        ...
        <div class="px-4" style="margin: auto">
            ...
            <form action="updateProduct?pID=<%=pID%>" method="POST">
                <div class="form-group">
                    <label for="id">ID</label>
                    <input type="number" class="form-control" id="id" name="id" value="<%=pID%>" disabled style="background:#ccc;">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="cateID" name="cateID">
                        ...
                        <option value="<%=category.getCateID()%>" <% if (category.getCateID() == Integer.parseInt(cateID)) {%>selected<%}%> ><%=category.getCname()%></option>
                        <%}%>
                    </select>
                </div>
                <div class="form-group">
                    <label for="image2">Ảnh 2</label>
                    <input type="text" class="form-control" id="image2" name="image2" value="<%=image2%>">
                </div>
                <div class="form-group">
                    <label for="image3">Ảnh 3</label>
                    <input type="text" class="form-control" id="image3" name="image3" value="<%=image3%>">
                </div>
                <div class="form-group">
                    <label for="image4">Ảnh 4</label>
                    <input type="text" class="form-control" id="image4" name="image4" value="<%=image4%>">
                </div>
